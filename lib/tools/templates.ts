...
export const MESSAGE_TEMPLATES = {
  PRACTICE_INFO: {
    hours: () => `${PRACTICE_CONFIG.NAME} is open Monday to Thursday ${PRACTICE_CONFIG.HOURS.monday}, Friday ${PRACTICE_CONFIG.HOURS.friday}, Saturday ${PRACTICE_CONFIG.HOURS.saturday}, and ${PRACTICE_CONFIG.HOURS.sunday} on Sundays.`,
  ...
  CONFIRMATION: (name: string, date: string, time: string, appointmentId?: string) => ({
    ...
    responseMessage: "Perfect! I've sent you a confirmation message with your appointment details. Please check your phone."
  }),
  BOOKING: {
